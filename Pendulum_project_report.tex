...
Figure \ref{fig:c4oe} and \ref{fig:c4om} use the voltage level we were given. These graphs have the correct radius for the motor. They show the long pendulum staying inverted for approximately 12 seconds.

\begin{figure}
\centering
\subfloat[Estimated]{{
	\includegraphics[width=0.5\linewidth]{4th_Order_Live_State_Estimate}
	\label{fig:c4oe}
}}
\subfloat[Measured]{{
